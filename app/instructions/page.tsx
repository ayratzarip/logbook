    ...
    <div className="min-h-screen bg-gray-95 dark:bg-brand-10">
      ...
      <main className="container mx-auto px-4 py-6 max-w-3xl space-y-8 pb-20">
        <section>
          <Card>
            <CardHeader>
              <CardTitle>Для чего нужен журнал самонаблюдения</CardTitle>
            </CardHeader>
        ...
        <section>
            <Card>
            <CardHeader>
              <CardTitle>Когда заполнять журнал</CardTitle>
            </CardHeader>
             <CardContent className="space-y-4 text-gray-700 dark:text-gray-300">
                <ul className="list-decimal pl-5 space-y-2">
                    <li>В первые две-три недели записываем каждый очный или заочный социальный контакт.</li>
                    <li>В первые недели записываем каждый раз, когда меняется настроение.</li>
                    <li>Во время формирования цели нужно сделать шаги к ней и записать это.</li>
